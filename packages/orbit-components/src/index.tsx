...
export {
  ...
  CardHeader as DeprecatedCardHeader,
  CardSection as DeprecatedCardSection,
} from "./deprecated/Card";
...
export { default as TripSector, TripDate, TripLayover } from "./deprecated/TripSector";
